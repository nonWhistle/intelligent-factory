...
public class LowOEEAlarm {

    CounterRepository counterRepository;

    public LowOEEAlarm(CounterRepository counterRepository) {
    ...
    /**
     * createAlarmLabel() returns a label to the alarmService method in this class.
    ...
    /**
     * createDialog() returns a Dialog to the alarmService method in this class.
